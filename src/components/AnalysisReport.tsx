          ...
          >
            ...
            <div className="flex gap-4">
              ...
              <button 
                ...
                className="flex-[2] py-4 bg-brand-primary text-text-inverse font-black text-sm rounded-xl hover:bg-brand-primary/90 transition-all shadow-xl shadow-brand-primary/20 uppercase tracking-widest"
              >
              ...
              <div className="p-6 border-b border-brand-border flex items-center justify-between bg-brand-surface/30">
                ...
                <div className="flex items-center gap-2">
                  <button 
                    ...
                    className="p-2 bg-brand-surface/50 text-text-muted hover:text-brand-primary border border-brand-border rounded-lg transition-all"
                    title="Edit Report"
                  >
                    <Edit2 size={18} />
                  </button>
