...
import { CheckSquare, Calendar, Download, Upload, ShieldCheck, BookOpen, Settings as SettingsIcon, ChevronLeft, ChevronRight, BarChart3, LayoutDashboard, Zap } from 'lucide-react';
import { cn } from '../types';

interface SidebarProps {
  activeTab: 'dashboard' | 'checklist' | 'calendar' | 'journal' | 'settings' | 'analysis' | 'downloads';
  setActiveTab: (tab: 'dashboard' | 'checklist' | 'calendar' | 'journal' | 'settings' | 'analysis' | 'downloads') => void;
  isOpen: boolean;
